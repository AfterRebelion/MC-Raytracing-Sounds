...
public class ASMHooks {
	...
	// NOT REMOVE!
	public static double soundDistanceAllowance = Config.soundDistanceAllowance.get(); /** {@link net.minecraft.server.management.PlayerList#sendToAllNearExcept radius}*/
